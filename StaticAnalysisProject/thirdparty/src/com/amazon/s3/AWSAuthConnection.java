...
public class AWSAuthConnection {
	...
	public Response put2(String bucket, String key, S3Object2 object, Map headers)
			throws MalformedURLException, IOException {
		
		S3Object obj = new S3Object(null,object.metadata); // create a dummy
		HttpURLConnection request = makeRequest("PUT", bucket,
				Utils.urlencode(key), null, headers, obj);

		request.setDoOutput(true);
		OutputStream os = request.getOutputStream();
		InputStream in = object.is;
